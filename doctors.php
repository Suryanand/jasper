...
<!--    <input type="text" name="location" required placeholder="City,State" class="form-control">   -->
						<select name="location" required id="category" data-placeholder="City/State" class="select form-control" data-prompt-position="topLeft:-1,-5">
...
<?php 
$rslt=mysqli_query($con,"select distinct area from tbl_trainers where type=3 order by area asc limit 0,5");
while($row=mysqli_fetch_assoc($rslt)){ ?>
...
<?php }?>
<?php 
$rslt=mysqli_query($con,"select distinct area from tbl_trainers where type=3 order by area asc limit 5,1000");
while($row=mysqli_fetch_assoc($rslt)){ ?>
...
<?php 
$rslt=mysqli_query($con,"select distinct nationality from tbl_trainers where type=3 order by nationality asc limit 0,5");
while($row=mysqli_fetch_assoc($rslt)){?>
<label class="filter-label">
<input type="checkbox" class="nationality" value="<?php echo $row["nationality"];?>"><?php echo $row["nationality"];?></label>
<?php }?>
<?php 
$rslt=mysqli_query($con,"select distinct nationality from tbl_trainers where type=3 order by nationality asc limit 5,1000");
while($row=mysqli_fetch_assoc($rslt)){?>
