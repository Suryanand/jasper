                  ...
                  <div class="newsletter">
                    <form action="search.php" method="get">
                      ...
                      <div class="col-md-2 col-xs-12 p-0">
                        <button type="submit" class="health-care-btn slider-btn bt-1 wow fadeInUp" style="padding:12px 30px;border:none;">Search Now</button>
                        <!-- Button --> 
                      </div>
                    </form>
                  </div>
                  ...
                  <div class="col-md-12" style="">
                    ...
                    <div class="single-testimonial-item mt-40" style="float: left;padding: 0px 11px 3px 21px;"> <!-- Start Single Testimonial -->
                      <div class="testimonial-icon" style=""> <!-- Reating Icon --> 
                        ...
                        <h4 style="margin-left: 54px;"><?php echo $row["categoryName"];?></h4>
                        </a> </div>
                    </div>
                    <?php } ?>
                    <div class="single-testimonial-item mt-40" style="float: left;padding: 0px 11px 3px 21px;"><!-- Start Single Testimonial -->
                      <div class="testimonial-icon" style=""> <!-- Reating Icon --> 
                        ...
                        <h4 style="margin-left: 54px;">Doctors </h4>
                        </a> </div>
                    </div>
                    ...
                    <div class="single-testimonial-item mt-40" style="float: left;padding: 0px 11px 3px 21px;"><!-- Start Single Testimonial -->
                      <div class="testimonial-icon" style=""> <!-- Reating Icon --> 
                        ...
                        <h4 style="margin-left: 54px;">Health & Fitness</h4>
                        </a> </div>
                    </div>
                    <div class="single-testimonial-item mt-40" style="float: left;padding: 0px 11px 3px 21px;"><!-- Start Single Testimonial -->
                      <div class="testimonial-icon" style=""> <!-- Reating Icon --> 
                        ...
                        <h4 style="margin-left: 54px;">Others</h4>
                        </a> </div>
                    </div>
                    <?php } else {  ?>
...
?>
                      ...
                      <!-- End Single Testimonial -->
                      <div class="single-testimonial-item mt-40" style="padding: 0px 11px 3px 21px;"><!-- Start Single Testimonial -->
...
<div id="departments" class="health-care-content-block"> <!-- Start Content Block -->
  <div class="container"> <!-- Start container -->
    ...
    <div class="row">
      <div class="col-md-7">
        <div class="doctor-info right-side"> <?php echo $row5['description'];?> <a href="<?php echo $absolutePath;?>login" class="health-care-btn view-all-btn">Create Your Account</a> </div>
      </div>
      <?php
if($row5['image']!=''){
?>
      <div class="col-md-5">
        <div class="profile-img left-side"> <img src="<?php echo $absolutePath;?>uploads/images/<?php echo $row5['image'];?>" class="img-responsive"> </div>
      </div>
      <?php } else {?>
      <div class="col-md-5">
        <div class="profile-img left-side"> <img src="<?php echo $absolutePath;?>uploads/default-home-pic.JPG" class="img-responsive"> </div>
      </div>
      <?php } ?>
    </div>
  </div>
...
<div id="articals" class="health-care-content-block"> <!-- Start Content Block -->
  <div class="container"> <!-- Start Container -->
    <div class="row">
      <div class="col-md-12"> <!-- Start Section Title -->
        <div class="section-title wow fadeIn"> <a href="<?php echo $absolutePath;?>articles">
    ...
    <div class="row">
      ...
      <div class="col-sm-4 col-md-4 ">
        <div id="blog-page" class="blog-post-box wow fadeIn"> <!-- Post Box --> 
          ...
          <div class="blog-post" style="background-image:url(<?php echo $absolutePath;?>uploads/images/blog/<?php echo $row["image"];?>);"></div>
          <!-- Post Image -->
          <div class="post-content">
            <h3><b><?php echo substr($row["title"],0,20);?>..</b></h3>
            </a>
            <p class="mt-10 mb-10"><i><?php echo $row["author"];?></i></p>
            <p><?php echo $buff;?></p>
            <div class="ta"> <a href="<?php if($row["postType"]==3) echo $absolutePath."uploads/pdf/".$row["link"]; elseif($row["postType"]==2) echo $row["link"]; else echo $absolutePath."article/".$row["urlName"];?>" class="">Read More</a>
              <div class="ta1"> <a  style="text-align:right" href="http://www.facebook.com/sharer.php?u=<?php if($row["postType"]==3) echo $absolutePath."uploads/pdf/".$row["link"]; elseif($row["postType"]==2) echo $row["link"]; else echo $absolutePath."article/".$row["urlName"];?>" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>&nbsp;&nbsp; <a style="text-align:right" href="http://twitter.com/share?url=<?php if($row["postType"]==3) echo $absolutePath."uploads/pdf/".$row["link"]; elseif($row["postType"]==2) echo $row["link"]; else echo $absolutePath."article/".$row["urlName"];?>" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a> </div>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="carousel-inner">
              <?php
							...
							while($row=mysqli_fetch_assoc($rslt))
							{
								$i++;
							?>
              <div class="item <?php if($i==1) echo "active";?> wht"> <?php echo $row["remarks"];?> <small><?php echo $row["fullName"];?> <cite title="Source Title"><?php echo $row["designation"];?></cite></small> </div>
              <?php }?>
            </div>
    ...
    <div class="row">
      <div class="col-md-12"> <!-- Start Section Title -->
        <div class="section-title wow fadeIn">
          ...
          <p style='text-align:left;text-transform:none;color:black;'>Subscribe to our email newsletter for a daily dose of health tips and articles.</p>
          <br clear='all'>
          <form method="post">
            <div class="col-md-6 col-xs-12 p-0 mr-5 mb-20">
              <div class="subscribe-form wow fadeInUp"> <!-- Subscribe Form -->
            ...
            <div class="col-md-2 col-xs-12 p-0">
              <input type="submit" name='subscribe' value='Subscribe' class="health-care-btn slider-btn bt-1 wow fadeInUp" style="padding:12px 30px;border:none;">
              <!-- Button --> 
            </div>
          </form>
        </div>
...
<!-- End blog Post Section -->
<div id="social" class="health-care-content-block"> <!-- Start Content Block -->
  <div class="container-fluid"> <!-- Start Container -->
   
      <div class="col-md-12"> <!-- Start Section Title -->
      <div class="social-blocks-slideshow">
        <div class="slideshow flex">
          <div class="social-block" style="background: url(http://demo.jaspermicron.com/alodawaa/final/images/social.jpg) center center / cover no-repeat; height: 259px;" data-colour="#333333">
            <div class="social-block-color-overlay" style="background:rgba(51,51,51,1.00)"></div>
            <a class="text-overlay text-align-center" style="color: rgb(255, 255, 255);">
            <h3 class="line-one title-line">Catch up!</h3>
            </a></div>
          <div class="social-block" style="background: url(http://demo.jaspermicron.com/alodawaa/final/images/social2.jpg) center center / cover no-repeat; height: 259px;" data-colour="#FFFFFF">
            <div class="social-block-color-overlay" style="background:rgba(255,255,255,1.00)"></div>
            <a class="text-overlay text-align-center" href="#" style="color: rgb(0, 0, 0);"> <span class="line-two">lorem ipsum dolor sit amet, consectetuer adipiscing elit.</span> </a> <a class="social-icon" href="#">
            <svg class="icon-mm icon-mm-social-share-icon-twitter">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-mm-social-share-icon-twitter-white"></use>
            </svg>
            </a></div>
          <div class="social-block" style="background: url(http://demo.jaspermicron.com/alodawaa/final/images/social4.jpg) center center / cover no-repeat; height: 259px;" data-colour="#000000">
            <div class="social-block-color-overlay" style="background:rgba(0,0,0,0.00)"></div>
            <a class="text-overlay text-align-center" href="#" style="color: rgb(255, 255, 255);"> </a> <a class="social-icon" href="#">
            <svg class="icon-mm icon-mm-social-share-icon-instagram">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-mm-social-share-icon-instagram-white"></use>
            </svg>
            </a></div>
          <div class="social-block" style="background: url(http://demo.jaspermicron.com/alodawaa/final/images/social3.jpg) center center / cover no-repeat; height: 259px;" data-colour="#333333">
            <div class="social-block-color-overlay" style="background:rgba(51,51,51,1.00)"></div>
            <a class="text-overlay text-align-center" href="#" style="color: rgb(255, 255, 255);"> <span class="line-two">@alodawaa</span> </a> <a class="social-icon" href="#">
            <svg class="icon-mm icon-mm-social-share-icon-facebook">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-mm-social-share-icon-facebook-white"></use>
            </svg>
            </a></div>
          <div class="social-block" style="background: url(http://demo.jaspermicron.com/alodawaa/final/images/social4.jpg) center center / cover no-repeat; height: 259px;" data-colour="#FFFFFF">
            <div class="social-block-color-overlay" style="background:rgba(255,255,255,1.00)"></div>
            <a class="text-overlay text-align-center" href="#" style="color: rgb(0, 0, 0);"> <span class="line-two">lorem ipsum dolor sit amet, consectetuer adipiscing elit.</span> </a> <a class="social-icon" href="#">
            <svg class="icon-mm icon-mm-social-share-icon-twitter">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-mm-social-share-icon-twitter-white"></use>
          ...
          <div class="social-block" style="background: url(http://demo.jaspermicron.com/alodawaa/final/images/social2.jpg) center center / cover no-repeat; height: 259px;" data-colour="#000000">
            <div class="social-block-color-overlay" style="background:rgba(0,0,0,0.00)"></div>
            <a class="text-overlay text-align-center" href="#" style="color: rgb(255, 255, 255);"> </a> <a class="social-icon" href="#">
            <svg class="icon-mm icon-mm-social-share-icon-instagram">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-mm-social-share-icon-instagram-white"></use>
          ...
          <div class="social-block" style="background: url(http://demo.jaspermicron.com/alodawaa/final/images/social.jpg) center center / cover no-repeat; height: 259px;" data-colour="#333333">
            <div class="social-block-color-overlay" style="background:rgba(51,51,51,0.70)"></div>
            <a class="text-overlay text-align-center" href="#" style="color: rgb(255, 255, 255);"> <span class="line-two">@alodawaa</span> </a> <a class="social-icon" href="#">
            <svg class="icon-mm icon-mm-social-share-icon-twitter">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-mm-social-share-icon-twitter-white"></use>
            </svg>
...
.social-blocks-slideshow .flex {
    -ms-flex-wrap: wrap;
    -webkit-flex-wrap: wrap;
    flex-wrap: wrap;
}
.social-blocks-slideshow .social-block {
    -ms-flex: 0 0 25%;
    -webkit-flex: 0 0 25%;
    flex: 0 0 25%;
    position: relative;
...
.social-blocks-slideshow .social-block-color-overlay {
    position: absolute;
    top: 0;
    left: 0;
    right: 0;
...
.social-blocks-slideshow .text-overlay {
    position: absolute;
    padding: 30px;
    top: 50%;
...
.social-blocks-slideshow .text-overlay h3 {
    color: inherit;
    text-align: center;
    font-weight: normal;
}
