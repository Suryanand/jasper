...
?>
<div class="header-area navbar-fixed-top sticky" style="height: 97px;">
					...
					<div class="col-md-9">
						<div class="main-menu" id="data-scroll"> <!-- Start Main Menu -->
							<ul class="nav" id="navigation" >
								...
								<li><a href="<?php echo $absolutePath;?>insurance">Insurance</a></li>
                                                                <li><a href="<?php echo $absolutePath;?>about">About Us</a></li>
