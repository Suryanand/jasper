			...
			<div class="container"> <!-- Start container -->
				...
				<div class="row">
					...
					<div class="col-md-3" style="margin-top: -7px;">
						...
						<span id="x" style="color:white; font-size:30px;cursor:pointer;margin-left: -54px;margin-top:10px!important;" onclick="openNav()">&#9776;</span>
							<a href="<?php echo $absolutePath;?>">								
								<img style="margin-left:20px;margin-bottom:10px!important;" src="<?php echo $absolutePath;?>images/<?php echo $logo;?>" alt="<?php echo $logoAlt;?>">
							</a>
						</div>
					...
					<div class="col-md-9">
						<div class="main-menu" id="data-scroll"> <!-- Start Main Menu -->
							<ul class="nav" id="navigation" >
                                                             ...
                                                             <!--  <li id="doc"><a class="link-1" href="#">Ask a Doctor</a><i style=" color: #fff; font-size: 11px; position: absolute; right: 25%;">coming soon</i></li>
                                                                <li id="boo"><a class="link-1" href="#">Book an Appointment</a><i style=" color: #fff; font-size: 11px; position: absolute; right: 40%;">coming soon</i></li>
								<li id="ins" class="</?php if($pageName=='insurance'){ echo "active";}?>"><a class="link-1" href="</?php echo $absolutePath;?>insurance">Insurance</a></li>
                                                                <li id="abo" class="<//?php if($pageName=='about'){ echo "active";}?>"><a class="link-1" href="</?php echo $absolutePath;?>about">About Us</a></li> */-->
