							...
							<div class="container">
								<div class="row">
									<div class="col-md-12 slider-content"> <!-- Slider Text & Button -->
										<h2 class="wow fadeInDown">Manage Doctors</h2>
										<ol class="breadcrumb">
			...
			<div class="container">	<!-- Start Container -->			
				...
				<div class="row">				
					...
					<div class="contact-form col-md-9" style="margin-top:25px;"> <!-- Start Form Group -->
						<h3>Doctors <a href="new-doctor.php" class="pull-right">Add New</a></h3>
						<table class="table">
							<thead>
								<tr>
									<th>Sr. No.</th>
							...
							<thead>
								<?php 
								$i=0;
								$rslt=mysqli_query($con,"select * from tbl_doctors where userId='".$_SESSION["user_id"]."'");
