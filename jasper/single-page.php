								...
								<div class="row">
									<div class="col-md-12 slider-content"> <!-- Slider Text & Button -->
										...
										<ol class="breadcrumb">
                                            ...
                                            <li><a href="<?php echo $absolutePath;?>articles">Blog</a></li>                                            
...
<aside id="sticky-social" style="margin-top: 185px;">
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=<?php if($postType==3) echo $absolutePath."uploads/pdf/".$row["link"]; elseif($postType==2) echo $row["link"]; else echo $absolutePath."article/".$urlName;?>" class="entypo-facebook" target="_blank"></a></li>
<li><a href="http://twitter.com/share?url=<?php if($postType==3) echo $absolutePath."uploads/pdf/".$row["link"]; elseif($postType==2) echo $row["link"]; else echo $absolutePath."article/".$urlName;?>" class="entypo-twitter" target="_blank"></a></li>
       ...
       <!-- Start Single Post Section -->
		<div class="health-care-content-block solid-color no-padding"> <!-- Start Content Block -->
			<div class="container">	<!-- Start Container -->			
				<div class="row">
					<div class="col-md-12"> <!-- Full Post-->
						<div class="blog-single-page"> <!-- Post Box -->
							 <!-- Post Image -->
							<div class="post-content">
								<h3 style="text-align:center"><b><?php echo $blogTitle;?></b></h3>
                               <div style="text-align:center"> <ul><i>
...
?>
<a href="<?php if($row5["postType"]==3) echo $absolutePath."uploads/pdf/".$row5["link"]; elseif($row5["postType"]==2) echo $row5["link"]; else echo $absolutePath."article/".$row5["urlName"];?>">        
<h4><?php echo substr($row5['title'],0,30);?></h4>
<?php echo substr($row5['description'],0,45);?>...</a>
<hr>
<?php } ?>
</div>
