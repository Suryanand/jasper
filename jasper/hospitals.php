...
<?php } ?>    
					...
					{?>
                                        ...
                                        <div class="input-group mb-20">
                                        <div class="subscribe-form wow fadeInUp">  <!-- Subscribe Form -->	
                                        <select name="ins" class="form-control ico-01">
			...
			<div class="container "> <!-- Start container --> 
				...
				<div class="row">
                    ...
                    <div class="contact-info wow fadeIn">
						...
						<?php 
						$rslt=mysqli_query($con,"select distinct area from tbl_firm where area!='' and companyType='$companyType' order by area asc limit 0,5");
						while($row=mysqli_fetch_assoc($rslt))
						{
						?>
						...
						<?php }?>
                                                <?php 
						$rslt=mysqli_query($con,"select distinct area from tbl_firm where area!='' and companyType='$companyType' order by area asc limit 5,1000");
						while($row=mysqli_fetch_assoc($rslt))
						{
						?>
                      ...
                      <div class="contact-info wow fadeIn">
						...
						<?php 
						$rslt=mysqli_query($con,"select distinct specialty from tbl_firm where companyType='$companyType' and  specialty!=''");
						while($row=mysqli_fetch_assoc($rslt))
						{
