...
<!--                                                   						<div class="container">
 					...
 					<ol class="breadcrumb" style="text-transform: capitalize!important;">
                                            <li><a href="<?php echo $absolutePath;?>">home</a> / <?php if($companyType==1) { ?> <a href="<?php echo $absolutePath;?>category/hospitals">hospitals /</a> <?php } elseif($companyType==2) {?> <a href="<?php echo $absolutePath;?>category/medical-centers">clinics / </a><?php } else { ?> <a href="<?php echo $absolutePath;?>category/pharmacies">pharmacies / </a><?php } echo strtolower($companyName);?></li>                                            
...
<p class="mt-10"><?php echo $work_hours;?></p>
<p class="mt-10">
...
<button name="spec" value="<?php echo $row['id'];?>" style="color:white;background:#2591fd;border:#2591fd;border-radius:50px;margin-top: 4px;margin-right: 10px;"><?php echo $row['Name'];?></button>
