...
<!--                                                   						<div class="container">
 					...
 					<ol class="breadcrumb" style="text-transform: capitalize!important;">
                                            <li><a href="<?php echo $absolutePath;?>">home</a> / <a href="<?php echo $absolutePath;?>gymnasiums">gymnasiums</a> / <?php echo substr(strtoupper($companyName),0,1);?><?php echo substr(strtolower($companyName),1);?></li>                                            
...
<div class="col-md-12 contact-info wow fadeIn" style=" margin-bottom:10px">
<div class="tab">
<button class="tablinks" style="font-size: 15px;" onclick="openCity(event, '1')" id="defaultOpen">About Us</button>
<button class="tablinks" style="font-size: 15px;" onclick="openCity(event, '2')">Location</button>
<button class="tablinks" style="font-size: 15px;" onclick="openCity(event, '3')">Fitness Trainers</button>
<button class="tablinks" style="font-size: 15px;" onclick="openCity(event, '4')">Club Manager</button>
<button class="tablinks" style="font-size: 15px;" onclick="openCity(event, '5')">Contact Us</button>
<button class="tablinks" style="font-size: 15px;" onclick="openCity(event, '6')">Gallery</button>
</div><br clear="all">
...
if(!empty($trainer)){
$sl=1;
$catArray=explode(',',$trainer);
$rslt=mysqli_query($con,"select * from tbl_trainers where type=0 and activeStatus=1 order by fullName asc");
while($row=mysqli_fetch_array($rslt))
{											
?>
<?php if(in_array($row["id"],$catArray)){?>    
<td><a href="<?php echo $absolutePath;?>trainers/<?php echo $row['urlName'];?>"><img src="<?php echo $absolutePath;?>uploads/images/trainers/<?php echo $row['image'];?>" style="width:100px;height:100px"><br><?php echo substr($row['fullName'],0,20);?>...</a></td>
...
<tr>
<?php
if(!empty($clubmanager)){
$sl=1;
$catArray=explode(',',$clubmanager);
$rslt=mysqli_query($con,"select * from tbl_trainers where type=2 and activeStatus=1 order by fullName asc");
while($row=mysqli_fetch_array($rslt))
{											
?>
<?php if(in_array($row["id"],$catArray)){?>    
...
<div>
<?php
$rslt=mysqli_query($con,"select * from tbl_gymnasium_gallery where firm_id=$uid");
while($row=mysqli_fetch_array($rslt))
{
?>    
...
<form method="post" action="<?php echo $absolutePath;?>gymnasium-specialty">
...
<?php } ?>
<?php
$rslt=mysqli_query($con,"select * from tbl_gymnasium where companyType='$companyType' and id!=$uid and activeStatus=1 order by companyName asc limit 4");
while($row=mysqli_fetch_assoc($rslt)){
...
<div class="col-md-9">
<a href="<?php echo $absolutePath."gymnasiums/".$row["urlName"];?>"><b style="margin:0px;"><?php echo substr($row["companyName"],0,20);?></b></a>
