...
<?php } ?>    
					...
					{?>
                                        ...
                                        <?php 
					$rslt=mysqli_query($con,"select * from tbl_specialty where activeStatus=1");
					while($row=mysqli_fetch_assoc($rslt))
					{?>
                                        ...
                                        <?php 
					$rslt=mysqli_query($con,"select * from tbl_insurance where activeStatus=1");
					while($row=mysqli_fetch_assoc($rslt))
					{?>
			...
			<div class="container "> <!-- Start container --> 
				...
				<div class="row">
                    ...
                    <div class="contact-info wow fadeIn">
						...
						<?php 
						$rslt=mysqli_query($con,"select distinct area from tbl_firm where activeStatus=1 and area!='' limit 0,5");
						while($row=mysqli_fetch_assoc($rslt))
						{
						?>
						...
						<?php }?>
                                                <?php 
						$rslt=mysqli_query($con,"select distinct area from tbl_firm where activeStatus=1 and area!='' limit 5,1000");
						while($row=mysqli_fetch_assoc($rslt))
						{
						?>
