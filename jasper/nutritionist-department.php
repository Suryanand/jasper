...
<!--              <div class="col-md-4">
        ...
        <div class="contact-info wow fadeIn">
                  ...
                  <?php 
						$rslt=mysqli_query($con,"select distinct location from tbl_trainers where activeStatus=1 and type=1");
						while($row=mysqli_fetch_assoc($rslt))
						{
						?>
                  <label class="filter-label">
        ...
        <?php 
					$rslt=mysqli_query($con,"select * from tbl_trainers where activeStatus=1 and type=1 and specialized like'%$specid%'");
					while($row=mysqli_fetch_assoc($rslt))
					{
						if(!empty($row["image"]))
						{
...
//						$row5=mysqli_fetch_assoc($rslt5);
       ...
       <a href="<?php echo $absolutePath;?>nutritionists/<?php echo $row["urlName"];?>"> <div class="col-md-4 p-0 black-tab">
