...
$id=$_GET["id"];
$rslt=mysqli_query($con,"select * from tbl_branches where id='".$id."'");
...
if(isset($_POST["submit"]))
{
	...
	mysqli_query($con,"update tbl_branches set location='$location',branchName='$branchName',address='$address',fax='$fax',contactNo='$contactNo',email='$email',googleMap='$googleMap',activeStatus='$activeStatus',timing='$timing' where id='".$id."'");	
	$_SESSION["response"]='Branch Updated';
	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
				...
				<h5 class="widget-name"><i class="icon-sitemap"></i>Edit Branch <a href="manage-branches.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-arrow-left"></i>Back</a></h5>
	                <fieldset>
	                    ...
	                    <div class="widget">
							...
							<div class="span6 well">
									<div class="control-group">
										 ...
										 <div class="controls">
											...
											{
											?>
												<option value="<?php echo $row["id"];?>"<?php if($row["id"]==$location) echo "selected";?>><?php echo $row["region"];?></option>
											<?php 
											}?>
											</select>
										 </div>
									...
									<div class="control-group">
										 ...
										 <div class="controls">
											 <input type="text" value="<?php echo $branchName;?>" class="validate[required] input-xlarge"  name="branchName" id="branchName"/>
										 </div>
									</div>									
									<div class="control-group">
	                        ...
	                        <div class="span6 well">								
									 <div class="control-group">
										 ...
										 <div class="controls">
											 <input type="text" value="<?php echo $email;?>" class="validate[required,custom[email]] input-xlarge"  name="email" id="email"/>
										 </div>
									 </div>
									 ...
									 <div class="control-group">
										 ...
										 <div class="controls">
											 <input type="text" value="<?php echo $timing;?>" class="validate[required] input-xlarge"  name="timing" id="timing"/>
										 </div>
									 </div>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<label class="radio inline">
												<input class="styled" type="radio" name="activeStatus" <?php if($activeStatus == 0) {echo "checked";}?>  id="draft" value="0" data-prompt-position="topLeft:-1,-5"/>
												Draft
											</label>
											<label class="radio inline">
												<input class="styled" type="radio" name="activeStatus" <?php if($activeStatus == 1) {echo "checked";}?> id="publish" value="1" data-prompt-position="topLeft:-1,-5"/>
												Publish
											</label>
										</div>
									</div>
