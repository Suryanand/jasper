...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B1', 'Specialized In')
            ->setCellValue('C1', 'Educational Degrees')
...
$rslt=mysqli_query($con,"Select * from tbl_doctors");
$i=1;
while($row=mysqli_fetch_array($rslt))
{
	...
	$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B'.$i, $row["specialized"])
            ->setCellValue('C'.$i, $row['qualification'])
