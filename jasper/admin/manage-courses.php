...
if(isset($_POST["delete"]))
{
	...
	/* delete category */
	mysqli_query($con,"update tbl_course set deleteStatus=1 where id='$deleteId'");
	$_SESSION['response'] = 'Course Deleted';
...
if(isset($_POST["change"]))
{
	...
	mysqli_query($con,"update tbl_course set sortOrder='".$order."' where id='".$id."'");
	echo "<script>location.href = 'manage-courses.php';</script>";exit();
}
if(isset($_POST["update-all-order"]))
{ 
	$rslt=mysqli_query($con,"select * from tbl_course");
	while($row=mysqli_fetch_array($rslt))
	{
		...
		mysqli_query($con,"update tbl_course set sortOrder='".$sortOrder."' where id='".$id."'") or die(mysqli_error($con));
	}
	//echo "<script>location.href = 'manage-courses.php';</script>";exit();
}
?>
	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
		    	...
		    	<h5 class="widget-name"><i class="icon-barcode"></i>Manage Course
                <a href="new-course.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-plus"></i>Add New</a>
				</h5>
                ...
                <form id="validate" class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        <table class="table table-striped table-bordered table-checks media-table">
                            ...
                            <?php
							$rslt=mysqli_query($con,"SELECT t1.`id`,t1.courseName,t1.sortOrder,t2.categoryName
FROM tbl_course t1 
                                ...
                                <tr>
			                        ...
			                        <td>
		                                <ul class="navbar-icons">
		                                    ...
		                                    <li><a href="edit-course.php?id=<?php echo $row['id'];?>" class="tip" title="Edit"><i class="icon-pencil"></i></a></li>
