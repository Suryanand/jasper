...
$id=$_GET["id"];
$rslt=mysqli_query($con,"select * from tbl_press where id='".$id."'");
...
if(isset($_POST["submit"]))
{
	...
	// insert into table
	mysqli_query($con,"UPDATE tbl_press set title='".$title."',image='".$newsImage."',category='$category', publishDate='$publishDate', postType='$postType', link='$link', description='$details', updatedOn=NOW(),arabicDoc='$arabicDoc', titleTag='$titleTag', urlName='$urlName', metaDescription='$metaDescription', metaKeywords='$metaKeywords',activeStatus='$activeStatus' where id='".$id."'") or die(mysqli_error($con));
	...
	if($_POST["submit"]=="submit-close")
		...
		echo "<script>location.href = 'edit-press.php?id=".$id."';</script>";
}
if(isset($_POST["deleteDoc"]))
{
	mysqli_query($con,"update tbl_press set arabicDoc='' where id='".$id."'");
	echo "<script>location.href = 'edit-press.php?id=".$id."';</script>";
}
?> 
<!DOCTYPE html>
	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
				...
				<h5 class="widget-name"><i class="icon-tasks"></i>Edit Press Release<a href="manage-press.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-arrow-left"></i>Back</a></h5>
	                    ...
	                    <div class="widget">
							...
							<div class="well row-fluid">								
                                ...
                                <div class="control-group ">
	                                ...
	                                <div class="controls">
										<?php if(!empty($newsImage)){?><img src="../uploads/images/news/<?php echo $newsImage;?>" width="70"><?php }?>
								...
								<div class="control-group">
	                                ...
	                                <div class="controls">
										...
										<?php if(!empty($arabicDoc)){?><a href="../uploads/pdf/<?php echo $arabicDoc;?>"><i class="icon-download" style="margin-top: 10px;"></i>&nbsp;&nbsp;&nbsp;<?php echo $arabicDoc;?></a>
										<button type="submit" name="deleteDoc" style="background:transparent;border:none;"><i class="icon-remove"></i></button>
										<?php }?>
