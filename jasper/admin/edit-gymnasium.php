...
error_reporting(0);
$id=$_GET["id"];
$rslt=mysqli_query($con,"select * from tbl_gymnasium where id='$id'");
...
mysqli_query($con,"insert into tbl_gymnasium_gallery(image,firm_id,updatedOn)values('".$galleryimage."','".$id."',NOW())") or die(mysqli_error($con));    
}
...
mysqli_query($con,"delete from tbl_gymnasium_gallery where id='$deleteId'");
...
<form id="validate" class="form-horizontal" action="" enctype="multipart/form-data" method="post">
				<h5 class="widget-name"><i class="icon-sitemap"></i>Edit Gymnasium <a href="manage-gymnasium.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-arrow-left"></i>Back</a></h5>
...
<li><a href="#tab7" data-toggle="tab">Club Managers</a></li>
	                    ...
	                    <div class="widget">
							...
							<div class="span6 well">
									...
									<div class="control-group">
										 ...
										 <div class="controls">
											 <input type="text" style="width:100%" value="<?php echo $companyName;?>" class="validate[required] input-xlarge"  name="companyName" id="companyName"/>
										 </div>
									</div>									
									<div class="control-group">
										...
										<div class="controls">
										 ...
										 <div class="controls">
											 <input type="text" style="width:100%" value="<?php echo $work_hours;?>" class="validate[required] input-xlarge"  name="work_hours" id="companyName"/>
										 </div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
									 ...
									 <div class="control-group">
										 ...
										 <div class="controls">
											 <input style="width:100%" type="text" value="<?php echo $fax;?>" class="validate[] input-xlarge"  name="fax" id="fax"/>
										 </div>
									 </div>
...
<div class="controls">	
<?php
$rslt6=mysqli_query($con,"select * from tbl_gymnasium_timing where gymid='$id'");
...
{											
?>
<td><input class="styled validate[minCheckbox[1]]" <?php if(in_array($row["id"],$catArray)) echo "checked";?> type="checkbox" name="service[]" id="" value="<?php echo $row["id"];?>" data-prompt-position="topLeft:-1,-5"/><?php echo $row["name"];?></td>
<?php if($sl%8==0){ echo "<tr>";}?>
<?php $sl++;} ?> 
</tr>
</table>  
</div>
...
{											
?>
<td><input class="styled validate[minCheckbox[1]]" <?php if(in_array($row["id"],$catArray)) echo "checked";?> type="checkbox" name="trainer[]" id="" value="<?php echo $row["id"];?>" data-prompt-position="topLeft:-1,-5"/><?php echo $row["fullName"];?></td>
<?php if($sl%8==0){ echo "<tr>";}?>
<?php $sl++;} ?> 
</tr>
</table>  
...
<div class="well row-fluid">
<div class="span12 well">
<label class="control-label">Gallery Images: <span class="text-error">*</span></label>
<div class="controls">
...
<tbody>
<?php
$rslt=mysqli_query($con,"SELECT * from tbl_gymnasium_gallery where firm_id=$id");
$i=0;
while($row=mysqli_fetch_array($rslt))
{
$i++;
