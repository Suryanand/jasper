...
elseif($type==1)
	...
	$category="Pharmacy";
$rslt=mysqli_query($con,"SELECT t1.*,t2.fullName from tbl_firm t1 left join tbl_user_login t2 on t1.userId=t2.id where t1.companyType='$type' ORDER BY sortOrder asc");
$i=1;
