...
$id=$_GET["id"];
$rslt=mysqli_query($con,"select * from tbl_news where id='".$id."'");
...
if(isset($_POST["submit"]))
{
	...
	// insert into table
	mysqli_query($con,"UPDATE tbl_news set title='".$title."',image='".$newsImage."',category='$category', publishDate='$publishDate', postType='$postType', link='$link', description='$details', updatedOn=NOW(), titleTag='$titleTag', urlName='$urlName', metaDescription='$metaDescription', metaKeywords='$metaKeywords' where id='".$id."'") or die(mysqli_error($con));
	
	$rslt=mysqli_query($con,"select id from tbl_news order by id desc limit 1");
	$row=mysqli_fetch_assoc($rslt);

	// set response alert
	$_SESSION["response"]="News Saved";
	if($_POST["submit"]=="submit-close")
		echo "<script>location.href = 'manage-news.php';</script>";
	else
		echo "<script>location.href = 'edit-news.php?id=".$row["id"]."';</script>";
}
?> 
<!DOCTYPE html>
<html lang="en">
	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
				...
				<h5 class="widget-name"><i class="icon-tasks"></i>In the News<a href="manage-news.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-arrow-left"></i>Back</a></h5>
	                    ...
	                    <div class="widget">
							...
							<div class="well row-fluid">								
								...
								<div class="control-group hide">
	                                ...
	                                <div class="controls">
	                                    <select name="category" class="styled validate[required]">
										<option value="">Choose Category</option>
											<?php 
											$rslt=mysqli_query($con,"select * from tbl_news_category");
