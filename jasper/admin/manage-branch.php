...
{
	mysqli_query($con,"delete from tbl_branches where id='".$_POST["delete"]."'");
...
if(isset($_POST["change"]))
{
	...
	mysqli_query($con,"update tbl_branches set sortOrder='$order' where id='$catId'");
	echo "<script>location.href = 'manage-branch.php';</script>";exit();
}
...
if(isset($_POST["update-all-order"]))
{
	...
	while($row=mysqli_fetch_array($rslt))
	{
		...
		mysqli_query($con,"update tbl_branches set sortOrder='".$sortOrder."' where id='".$id."'");
	}
	echo "<script>location.href = 'manage-branch.php';</script>";exit();
}
?>
		    ...
		    <div class="wrapper">
                ...
                <form id="validate" class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        <table class="table table-striped table-bordered table-checks media-table">
                            ...
                            <?php
								$rslt=mysqli_query($con,"SELECT t1.*, t2.region
FROM tbl_branches t1 
LEFT JOIN tbl_locations t2 ON t1.location=t2.id 
