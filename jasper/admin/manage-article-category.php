...
if(isset($_GET["id"]))
{
	$rslt=mysqli_query($con,"select * from tbl_articles_category where id='".$_GET["id"]."'");
...
if(isset($_POST["submit"]))
{
	...
	if(isset($_GET["id"]))
	{
		mysqli_query($con,"update tbl_articles_category set category='".$category."' where id='".$_GET["id"]."'");
	}
	else
	{
		mysqli_query($con,"insert into tbl_articles_category(category) values('".$category."')");		
	}
	echo "<script>location.href = 'manage-article-category.php';</script>";exit();
}
if(isset($_POST["delete"]))
{
	$id	= mysqli_real_escape_string($con,$_POST["delete"]);
	mysqli_query($con,"delete from tbl_articles_category where id='".$id."'") or die(mysqli_error($con));
	echo "<script>location.href = 'manage-article-category.php'</script>";exit();
}
?>
<!DOCTYPE html>
...
<div id="container">
  ...
  <div id="content">
    ...
    <div class="wrapper">
      ...
      <br>
      <!-- /page header -->
      <h5 class="widget-name"><i class="icon-th"></i>Manage Article Category</h5>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><ul class="navbar-icons">
                    <li><a href="manage-article-category.php?id=<?php echo $row['id'];?>" class="tip" title="Edit"><i class="icon-pencil"></i></a></li>
                    <li>
