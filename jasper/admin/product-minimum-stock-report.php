	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
		    	...
		    	<h5 class="widget-name"><i class="icon-th"></i>Product Stocks
				</h5>
                ...
                <form id="validate" class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        ...
                        <table class="table table-striped table-bordered table-checks media-table2">
                            ...
                            <?php
							$rslt=mysqli_query($con,"SELECT t1.`productId`,t1.qcl,t1.qoh,t1.withoutQuantity,t1.productName,t1.availability,t2.categoryName,t3.BrandName
FROM tbl_products t1 LEFT JOIN `tbl_category` t2  ON t1.fkCategoryId = t2.categoryId LEFT JOIN `tbl_brands` t3 ON t1.`fkBrandId` = t3.`brandId` WHERE deleteStatus='0'");							
							...
							?>
                                <tr>
			                        ...
			                        <td><?php if($row["withoutQuantity"]==1) echo "-"; else echo $row['qcl']; ?></td>
			                        <!--<td><?php echo $sold; ?></td>-->
