...
if(isset($_POST["submit"]))
{
	...
	echo "<script>location.href = 'manage-clinic.php'</script>";exit();
	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
				...
				<h5 class="widget-name"><i class="icon-sitemap"></i>New Clinic <a href="manage-clinic.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-arrow-left"></i>Back</a></h5>
	                <fieldset>
