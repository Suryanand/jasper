...
if(isset($_POST["submit"]))
{
	...
	if(isset($_GET["id"]))
	{
		mysqli_query($con,"update tbl_job_category set categoryName='".$categoryName."' where id='".$_GET["id"]."'");
	}
	else
	{
		mysqli_query($con,"insert into tbl_job_category(categoryName) values('".$categoryName."')");		
	}
	echo "<script>location.href = 'manage-job-category.php';</script>";exit();
}
...
<div id="container">
  ...
  <div id="content">
    ...
    <div class="wrapper">
      ...
      <br>
      <!-- /page header -->
      <h5 class="widget-name"><i class="icon-th"></i>Manage Job Category</h5>
	                    ...
	                    <div class="widget">
	                    	<div class="well row-fluid">								
								<div class="control-group">
	                                <label class="control-label">Job Category: <span class="text-error">*</span></label>
	                                <div class="controls">
        ...
        <form id="validate" class="form-horizontal" action="" enctype="multipart/form-data" method="post">
          <table class="table table-striped table-bordered table-checks media-table">
            ...
            <tbody>
              ...
              <?php
                $rslt=mysqli_query($con,"SELECT * FROM tbl_job_category where parentId=0 order by sortOrder asc");
                $i=0;
                while($row=mysqli_fetch_array($rslt))
                {
                $i++;
              ...
              <tr>
                ...
                <td><ul class="navbar-icons">
                    <li><a href="manage-job-category.php?id=<?php echo $row['id'];?>" class="tip" title="Edit"><i class="icon-pencil"></i></a></li>
                    <li>
