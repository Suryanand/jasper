...
if(isset($_POST["submit"]))
{
	...
	$rslt=mysqli_query($con,"select * from tbl_links where client='$client'");
	...
	else
	{
		...
		mysqli_query($con,"insert into tbl_links (client,url,clientImage,altTag,activeStatus,createdOn,buttonCaption)values('".$client."','".$url."','".$clientImage."','".$altTag."','".$activeStatus."',NOW(),'".$buttonCaption."')") or die(mysqli_error($con));	
		echo "<script>location.href = 'manage-link.php'</script>";exit();
	}
}
?>
<!DOCTYPE html>
	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
			    ...
			    <br>
			    <!-- /page header -->
				<h5 class="widget-name"><i class="icon-user-md"></i>New Link <a href="manage-link.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-arrow-left"></i>Back</a></h5>
	                    ...
	                    <div class="widget">
	                    	<div class="well row-fluid">                            	                                
								...
								<div class="control-group">
	                                ...
	                                <div class="controls">
	                                    <input type="text" value="" class="validate[required] input-xlarge" name="buttonCaption" id="buttonCaption"/>					
