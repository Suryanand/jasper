...
$rslt=mysqli_query($con,"select * from tbl_trainers where type=3 and activeStatus=1");
while($row=mysqli_fetch_array($rslt))
{											
?>
<?php if(in_array($row["id"],$catArray)){?>    
<td><a href="<?php echo $absolutePath;?>doctors/<?php echo $row['urlName'];?>"><img src="<?php echo $absolutePath;?>uploads/images/trainers/<?php echo $row['image'];?>" style="width:100px;height:100px"><br><?php echo substr($row['fullName'],0,20);?>...</a></td>
...
<button name="spec" value="<?php echo $row['id'];?>" style="color:white;background:#2591fd;border:#2591fd;border-radius:50px;margin-top: 4px;"><?php echo $row['Name'];?></button>
