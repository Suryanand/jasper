	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
				...
				<h5 class="widget-name"><i class="icon-sitemap"></i>New Hospital <a href="manage-hospital.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-arrow-left"></i>Back</a></h5>
	                <fieldset>
									...
									<div class="control-group hide">
										...
										<div class="controls">
											<label class="radio inline">
												<input class="styled" type="radio" checked  name="companyType" id="publish" value="2" data-prompt-position="topLeft:-1,-5"/>
												Hospital
											</label>
											<label class="radio inline">
												<input class="styled" type="radio"  name="companyType" id="draft" value="1" data-prompt-position="topLeft:-1,-5"/>
												Clinic
											</label>
											<label class="radio inline">
