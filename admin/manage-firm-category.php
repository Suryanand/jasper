...
if(isset($_GET["id"]))
{
	$rslt=mysqli_query($con,"select * from tbl_firm_category where id='".$_GET["id"]."'");
...
if(isset($_POST["submit"]))
{
	...
	if(isset($_GET["id"]))
	{
		mysqli_query($con,"update tbl_firm_category set categoryName='".$categoryName."' where id='".$_GET["id"]."'");
	}
	else
	{
		mysqli_query($con,"insert into tbl_firm_category(categoryName) values('".$categoryName."')");		
	}
	echo "<script>location.href = 'manage-firm-category.php';</script>";exit();
}
if(isset($_POST["delete"]))
{
	$id	= mysqli_real_escape_string($con,$_POST["delete"]);
	mysqli_query($con,"delete from tbl_firm_category where id='".$id."'") or die(mysqli_error($con));
	echo "<script>location.href = 'manage-firm-category.php'</script>";exit();
}
?>
<!DOCTYPE html>
        ...
        <form id="validate" class="form-horizontal" action="" enctype="multipart/form-data" method="post">
          <table class="table table-striped table-bordered table-checks media-table">
            ...
            <tbody>
              ...
              <?php
                $rslt=mysqli_query($con,"SELECT * FROM tbl_firm_category");
                $i=0;
              ...
              <tr>
                ...
                <td><ul class="navbar-icons">
                    <li><a href="manage-firm-category.php?id=<?php echo $row['id'];?>" class="tip" title="Edit"><i class="icon-pencil"></i></a></li>
                    <li>
