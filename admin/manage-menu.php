...
{
	mysqli_query($con,"delete from tbl_jr_menu where id='".$_POST["delete"]."'");
	echo "<script>location.href = 'manage-menu.php';</script>";exit();
}
if(isset($_POST["change"]))
{
	$catId	= $_POST["change"];
	$order	= $_POST["order".$catId];
	mysqli_query($con,"update tbl_jr_menu set sortOrder='$order' where id='$catId'");
	echo "<script>location.href = 'manage-menu.php';</script>";exit();
}
...
if(isset($_POST["update-all-order"]))
{
	...
	while($row=mysqli_fetch_array($rslt))
	{
		...
		mysqli_query($con,"update tbl_jr_menu set sortOrder='".$sortOrder."' where id='".$id."'");
	}
	echo "<script>location.href = 'manage-menu.php';</script>";exit();
}
?>
	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
		    	...
		    	<h5 class="widget-name"><i class="icon-th"></i>Manage Services
                <a href="new-menu.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-plus"></i>Add New</a>
                </h5>
                ...
                <form id="validate" class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        <table class="table table-striped table-bordered table-checks media-table">
                            ...
                            <?php
								$rslt=mysqli_query($con,"SELECT t1.*, t2.categoryName
FROM tbl_jr_menu t1 
LEFT JOIN tbl_menu_category t2 ON t1.category=t2.id 
...
");
							...
							?>
                                <tr>
			                        ...
			                        <td><?php echo date('d M Y  H:i:s',strtotime($row["updatedOn"])); ?></td>
			                        ...
			                        <td>
		                                <ul class="navbar-icons">
		                                    <li><a href="edit-menu.php?id=<?php echo $row['id'];?>" class="tip" title="Edit"><i class="icon-pencil"></i></a></li>
