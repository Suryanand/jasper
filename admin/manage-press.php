...
if(isset($_POST["delete"]))
{
	...
	/* delete category */
		$rslt=mysqli_query($con,"select link from tbl_press where id='$deleteId'");
		$row  = mysqli_fetch_assoc($rslt);
		if(!empty($row["link"]))
		{
			unlink("../uploads/pdf/".$row["link"]);
		}
		mysqli_query($con,"delete from tbl_press where id='$deleteId'");
	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
		    	...
		    	<h5 class="widget-name"><i class="icon-tasks"></i>Manage Press Release
				<a href="new-press.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-plus"></i>Add New</a>
				</h5>
				...
				<div class="table-overflow">
					<form id="validate" class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        <table class="table table-striped table-bordered table-checks media-table">
                            ...
                            <!-- Display All Events and Events -->
<?php
							$rslt=mysqli_query($con,"select * from tbl_press");
							$i=0;
                                ...
                                <tr>
			                        ...
			                        <td>
		                                <ul class="navbar-icons">
		                                    <li><a href="edit-press.php?id=<?php echo $row['id'];?>" class="tip" title="Edit"><i class="icon-pencil"></i></a></li>
