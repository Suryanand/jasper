							...
							<div class="span6 well">
									...
									<div class="control-group">
										 ...
										 <div class="controls">
                                                                                         ...
                                                                                         <?php
                                                                                         $rslt5=mysqli_query($con,"select * from tbl_specialty order by id DESC");
                                                                                         while($row5=mysqli_fetch_assoc($rslt5)){
                                                                                         ?>
                                                                                         <input type="checkbox" name="specialized[]" value="<?php echo $row5['id'];?>"><?php echo $row5['Name'];?>
                                                                                         <?php } ?>
										 ...
										 <div class="controls">
											 <input type="text" value="" class="validate[required] input-xlarge" required  name="nationality" id="qualification"/>
										 </div>
									</div>
                                                            <div class="control-group">
										 ...
										 <div class="controls">
                                                                                         ...
                                                                                         <?php
                                                                                         $rslt6=mysqli_query($con,"select * from tbl_language order by id DESC");
                                                                                         while($row6=mysqli_fetch_assoc($rslt6)){
                                                                                         ?>
                                                                                         <input type="checkbox" name="language[]" value="<?php echo $row6['id'];?>"><?php echo $row6['Name'];?>
                                                                                         <?php } ?>
									...
									<div class="control-group">
										 ...
										 <div class="controls">
											 <input type="text" required value="" class="validate[] input-xlarge"  name="location" id="location"/>
										 </div>
									</div>
									<div class="control-group">
										 <label class="control-label">Area:<span class="text-error">*</span></label>
										 <div class="controls">
											 <input type="text" required value="" class="validate[] input-xlarge"  name="area" id="area"/>
										 </div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
									 ...
									 <div class="control-group">
										 ...
										 <div class="controls">
											 <input type="number"  class="input-xlarge"  name="age" id="age"/>
										 </div>
									 </div> 
								</div>
	                        <div class="span6 well">
...
<?php 
$sl=1;
$rslt=mysqli_query($con,"select * from tbl_firm where companyType='1' and activeStatus='1'");
while($row=mysqli_fetch_assoc($rslt))
{ $sl++;
?>    
<td title="<?php echo $row['companyName'];?>"><input type="checkbox" name="plid[]" value="<?php echo $row['id'];?>"> <?php echo substr($row['companyName'],0,10);?>...</td> 
<?php if ($sl=='6'){ echo "<tr>";}?>
<?php } ?>
</tr>
</table>    
