...
if(isset($_POST['submit']))
{
	...
	mysqli_query($con,"insert into tbl_products (productName,sku,price,sale_price,createdOn,updatedOn,displayFront,main_image,addon_product,shortDescription) values('".$productName."','".$sku."','".$price."','".$sale_price."',NOW(),NOW(),'".$displayFront."','".$main_image."','1','".$shortDesc."')") or die(mysqli_error($con));
	
	
	//fetch current product id
	$rslt			= mysqli_query($con,"select productId from tbl_products order by productId desc limit 1");
...
<body>
									...
									<div class="row-fluid">
										...
										<div class="widget well">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" value="" class="validate[required] input-xlarge" name="productName" id="productName"/>
												</div>
											</div>
											<!--<div class="control-group">
	...
	ORDER BY parentCategory");
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" value=""  class="validate[custom[number]] input-medium" name="price" id="price"/>
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" value="" class="validate[] input-xlarge" name="sku" id="sku"/>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">													
													<label class="radio inline">
														<input class="validate[] styled" checked type="checkbox" name="displayFront" id="displayFront" value="1" data-prompt-position="topLeft:-1,-5"/>
														Show on Front End
													</label>
												</div>
											</div>
										...
										<div class="widget well">
											<div class="control-group">
												...
												<div class="controls">
													<textarea rows="5" cols="5" name="shortDesc" class="validate[] span12"></textarea></div>
											</div>	                                                                                            
