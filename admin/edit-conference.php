...
$id=$_GET["id"];
$rslt=mysqli_query($con,"select * from tbl_conference where id='".$id."'");
...
if(isset($_POST["submit"]))
{
	...
	// insert into table
	mysqli_query($con,"UPDATE tbl_conference set title='".$title."', publishDate='$publishDate', postType='$postType', link='$link', description='$details', updatedOn=NOW(), titleTag='$titleTag', urlName='$urlName', metaDescription='$metaDescription', metaKeywords='$metaKeywords' where id='".$id."'");
	                    ...
	                    <div class="widget">
							...
							<div class="well row-fluid">								
                                ...
                                <div class="control-group">
	                                ...
	                                <div class="controls">
	                                    <textarea rows="5" cols="5" name="details" class="validate[required] span12"><?php echo $description;?></textarea>
	                                </div>
	                            </div>	                            
                                <div class="control-group">
								...
								<div class="control-group">
	                                ...
	                                <div class="controls">
	                                    <select name="postType" onChange="getType(this.value)" class="validate[] input-xlarge" data-prompt-position="">
											<option value="1" <?php if($postType==1) echo "selected";?>>PDF</option>
											<option value="2" <?php if($postType==2) echo "selected";?>>URL</option>
	                                    </select>
	                                </div>
	                            </div>
                                <div class="control-group newsImg" <?php if($postType==2) echo "style='display:none;'";?>>
								...
								<div class="control-group newsVdo" <?php if($postType==1) echo "style='display:none;'";?>>
