...
if(isset($_POST["submit"]))
{
	...
	mysqli_query($con,"insert into tbl_firm(userId,location,companyName,address,contactNo,fax,googleMap,activeStatus,titleTag,metaDescription,metaKeywords,urlName,companyType,country,area,network1,network2,image,branchId)values('0','".$location."','$companyName','$address','$contactNo','$fax','$googleMap','$activeStatus','".$titleTag."','$metaDescription','$metaKeywords','$urlName','$companyType','$country','$area','$network1','$network2','$firmImage','$branchId')") or die(mysqli_error($con));
	$_SESSION["response"]='Hospital Saved';
	echo "<script>location.href = 'manage-pharmacy.php'</script>";exit();
	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
				...
				<h5 class="widget-name"><i class="icon-sitemap"></i>New Pharmacy <a href="manage-pharmacy.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-arrow-left"></i>Back</a></h5>
	                <fieldset>
	                    ...
	                    <div class="widget">
							...
							<div class="span6 well">
									...
									<div class="control-group hide">
										...
										<div class="controls">
											<label class="radio inline">
												<input class="styled" type="radio"   name="companyType" id="publish" value="2" data-prompt-position="topLeft:-1,-5"/>
												Hospital
											</label>
											<label class="radio inline">
												<input class="styled" type="radio" checked name="companyType" id="draft" value="1" data-prompt-position="topLeft:-1,-5"/>
												Clinic
											</label>
											<label class="radio inline">
												<input class="styled" type="radio"  name="companyType" id="draft" value="3" data-prompt-position="topLeft:-1,-5"/>
												Pharmacy
											</label>
									...
									<div class="control-group">
										 ...
										 <div class="controls">
											 <input type="text" value="" class="validate[required] input-xlarge"  name="companyName" id="companyName"/>
										 </div>
									</div>									
									<div class="control-group">
									...
									<div class="control-group">
									 ...
									 <div class="control-group">
										 ...
										 <div class="controls">
											 <input type="text" value="" class="validate[] input-xlarge"  name="network1" id="network2"/>
										 </div>
									</div>
									<div class="control-group">
										 <label class="control-label">Network 2:</label>
										 <div class="controls">
											 <input type="text" value="" class="validate[] input-xlarge"  name="network2" id="network2"/>
										 </div>
									</div>
