...
$id=$_GET["id"];
$rslt=mysqli_query($con,"select * from tbl_delivery_info where id='".$id."'");
...
if(isset($_POST["submit"]))
{
	...
	mysqli_query($con,"update tbl_delivery_info set question='$question',answer='$answer' where id='".$id."'") or die(mysqli_error($con));
