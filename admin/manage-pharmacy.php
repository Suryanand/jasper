	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
		    	...
		    	<h5 class="widget-name"><i class="icon-th"></i>Manage Pharmacy
                <a href="new-pharmacy.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-plus"></i>Add New</a>
                <a href="export-hospital.php?id=3" style="float:right;color:#555 !important;margin-right:10px;"><i style="padding:4px;" class="icon-download"></i>Export</a>
                </h5>
                ...
                <form id="validate" class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        <table class="table table-striped table-bordered table-checks media-table">
                            ...
                            <?php
								$rslt=mysqli_query($con,"SELECT t1.*,t2.fullName from tbl_firm t1 left join tbl_user_login t2 on t1.userId=t2.id where t1.companyType=3 ORDER BY sortOrder asc");
								$i=0;
								while($row=mysqli_fetch_array($rslt))
								{
                                ...
                                <tr>
			                        ...
			                        <td>
		                                <ul class="navbar-icons">
		                                    <li><a href="edit-pharmacy.php?id=<?php echo $row['id'];?>" class="tip" title="Edit"><i class="icon-pencil"></i></a></li>
