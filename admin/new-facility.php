...
if(isset($_POST["submit"]))
{
	...
	$rslt=mysqli_query($con,"select * from tbl_facilties where facility='$facility'");
	if(mysqli_num_rows($rslt)>0) 
	{/* email already registered */
		$_SESSION["response"]="ECA already created";
	}
	else
	{	
	...
	mysqli_query($con,"insert into tbl_facilties (facility,description,image,titleTag,metaDescription,metaKeywords,urlName)values('".$facility."','".$description."','".$imageName."','$titleTag','$metaDescription','$metaKeywords','$urlName')") or die(mysqli_error($con));
	$rslt=mysqli_query($con,"select id from tbl_facilties order by id desc limit 1");
	...
	if($_POST["submit"]=="submit-close")
		...
		echo "<script>location.href = 'edit-facility.php?id=".$id."'</script>";
	}
}
?>
<!DOCTYPE html>
	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
			    ...
			    <br clear="all"/>
				<h5 class="widget-name"><i class="icon-th"></i>New ECA
	                    ...
	                    <div class="widget">
							...
							<div class="well row-fluid">                            	                                
                                <div class="control-group">
	                                ...
	                                <div class="controls">
	                                    <input type="text" value="" class="validate[required] input-xlarge" name="facility" id="facility"/>					
