...
if(isset($_POST["submit"]))
{
	...
	// insert into table
	mysqli_query($con,"INSERT INTO tbl_news (title,category,image, publishDate, postType, link, description, updatedOn, titleTag, urlName, metaDescription, metaKeywords) VALUES ('$title', '$category','$newsImage','$publishDate', '$postType', '$link', '$details', NOW(), '$titleTag', '$urlName', '$metaDescription', '$metaKeywords')");
