...
if(isset($_POST["submit"]))
{
	...
	// insert into table
	mysqli_query($con,"INSERT INTO tbl_articles (title,category,image, publishDate, postType, link, description, updatedOn, titleTag, urlName, metaDescription, metaKeywords,author) VALUES ('$title', '$category','$newsImage','$publishDate', '$postType', '$link', '$details', NOW(), '$titleTag', '$urlName', '$metaDescription', '$metaKeywords','$author')");
	
	$rslt=mysqli_query($con,"select id from tbl_articles order by id desc limit 1");
	...
	if($_POST["submit"]=="submit-close")
		...
		echo "<script>location.href = 'edit-blog.php?id=".$row["id"]."';</script>";
}
?> 
<!DOCTYPE html>
<html lang="en">
	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
				...
				<h5 class="widget-name"><i class="icon-tasks"></i>New Blog<a href="manage-blog.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-arrow-left"></i>Back</a></h5>
	                    ...
	                    <div class="widget">
							...
							<div class="well row-fluid">								
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="" class="validate[] input-xxlarge" name="author" id="author"/>
	                                </div>
	                            </div>
