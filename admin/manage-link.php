...
if(isset($_POST["delete"]))
{
	$deleteId	= mysqli_real_escape_string($con,$_POST["delete"]);
		$rslt = mysqli_query($con,"select clientImage from tbl_links where id='$deleteId'");
		...
		mysqli_query($con,"delete from tbl_links where id='$deleteId'");
...
if(isset($_POST['submitOrder']))
{
		...
		$order="order".$bId;
		$bOrder=$_POST[$order];
		mysqli_query($con,"update tbl_links set clientOrder='$bOrder' where id='$bId'") or die(mysqli_error($con));							
...
if(isset($_POST["down"]))
{
	...
	$rslt=mysqli_query($con,"select * from tbl_links where activeStatus=1 order by clientOrder asc");
	$j=0;
	...
	mysqli_query($con,"update tbl_links set clientOrder='$clientOrder' where id='$id'");
	}
}
	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
		    	...
		    	<h5 class="widget-name"><i class="icon-th"></i>Manage Links
                <a href="new-link.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-plus"></i>Add New</a>
                </h5>
                ...
                <form id="validate" class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        <table class="table table-striped table-bordered table-checks media-table">
                            ...
                            <?php
								$rslt=mysqli_query($con,"SELECT * from tbl_links order by clientOrder asc");
								$i=0;
							...
							?>
                                <tr>
			                        ...
			                        <td><?php echo $row["buttonCaption"]; ?></td>
			                        ...
			                        <td>
		                                <ul class="navbar-icons">
		                                    <li><a href="edit-link.php?id=<?php echo $row['id'];?>" class="tip" title="Edit"><i class="icon-pencil"></i></a></li>
