...
if(isset($_POST["delete"]))
{
	$deleteId	= mysqli_real_escape_string($con,$_POST["delete"]);
		mysqli_query($con,"delete from tbl_delivery_info where id='".$deleteId."'");
	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
		    	...
		    	<h5 class="widget-name"><i class="icon-th"></i>Manage Delivery Information
                <a href="delivery-info.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-plus"></i>Add New</a>
                </h5>
                ...
                <form id="validate" class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        <table class="table table-striped table-bordered table-checks media-table">
                            ...
                            <?php
								$rslt=mysqli_query($con,"SELECT * from tbl_delivery_info");
								$i=0;
