...
//get voucher details
$rslt = mysqli_query($con,"select * from tbl_vouchers where id='".$editId."'");
$row = mysqli_fetch_assoc($rslt);
$voucherPlan = $row["voucherPlan"];
...
if(isset($_POST["submit"]))
{
	...
	$rslt=mysqli_query($con,"select * from tbl_vouchers where voucherPlan='".$voucherPlan."' and id!='".$editId."'");
	...
	{		
		mysqli_query($con,"update tbl_vouchers set voucherPlan='".$voucherPlan."',voucherAmount='".$amount."',activationPeriod='".$activationPeriod."',activeStatus='".$activeStatus."' where id='".$editId."'") or die(mysqli_error($con));
				
		$_SESSION["response"]="Voucher Updated";
	                    ...
	                    <div class="widget">
	                    	...
	                    	<div class="well row-fluid">                            	                                
                                <div class="control-group">
	                                ...
	                                <div class="controls">
	                                    <input type="text" value="<?php echo $voucherPlan;?>" class="validate[required] input-large" name="voucherPlan" id="voucherPlan"/>					
                                ...
                                <div class="control-group">
	                                ...
	                                <div class="controls">
	                                    <input type="text" value="<?php echo $amount;?>"  class="validate[required,custom[number]] input-large" name="amount" id="amount"/>
	                                </div>
	                            </div>
                                <div class="control-group">
	                                <label class="control-label">Activation Period (in days): <span class="text-error">*</span></label>
	                                <div class="controls">
	                                    <input type="text" value="<?php echo $activationPeriod;?>"  class="validate[required,custom[number]] input-large" name="activationPeriod" id="activationPeriod"/>
	                                </div>
	                            </div>                                                                
                                <div class="control-group">
