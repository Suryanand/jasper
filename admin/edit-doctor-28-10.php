	                    ...
	                    <div class="widget">
							...
							<div class="span6 well">
									...
									<div class="control-group">
										 ...
										 <div class="controls">
											 <input type="text" value="<?php echo $specialized;?>" class="validate[required] input-xlarge"  name="specialized" id="specialized"/>
										 </div>
									</div>
									<div class="control-group">
