...
{
	mysqli_query($con,"delete from tbl_comments where id='".$_POST["delete"]."'");
	echo "<script>location.href = 'doctor-comment.php';</script>";exit();
}
?>
<!DOCTYPE html>
<html lang="en">
	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
		    	...
		    	<h5 class="widget-name"><i class="icon-th"></i>Doctor Comments
                </h5>
                ...
                <form id="validate" class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        <table class="table table-striped table-bordered table-checks media-table">
                            ...
                            <?php
								$rslt=mysqli_query($con,"select * from tbl_comments order by id desc");
								$i=0;
							...
							?>
                                <tr>
									...
									<td><?php echo $row2["userFirstName"];?> <?php echo $row2["userLastName"];?></td>
                                                                         <?php
                                                                        $rslt3=mysqli_query($con,"select * from tbl_trainers where id=$octorId and type=3");
									...
									<td><?php echo $row["Ip"];?></td>
                                                                        ...
                                                                        <a href="doctor-disapprove.php?id=<?php echo $row['id'];?>" style="color:green"> Approved </a>
                                                                        <?php } else{ ?>
                                                                        <a href="doctor-approve.php?id=<?php echo $row['id'];?>" style="color:red"> Not Approved </a>
                                                                        <?php } ?>
                                                                        </td>
			                        <td>
