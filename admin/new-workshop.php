...
if(isset($_POST['submit']))
{
	...
	mysqli_query($con,"insert into tbl_workshops (workshop,description,price,discount,discountType,image,altTag,updatedOn,activeStatus,urlName,titleTag,metaDescription,metaKeywords) values('".$workshop."','".$description."','".$price_json."','".$discount."','".$discountType."','".$courseImage."','".$altTag."',NOW(),'".$activeStatus."','".$urlName."','".$titleTag."','".$metaDescription."','".$metaKeywords."')") or die(mysqli_error($con));
	
	//fetch current product id
	$rslt	= mysqli_query($con,"select id from tbl_workshops order by id desc limit 1");
	$row	= mysqli_fetch_assoc($rslt);
	$id		= $row["id"];

	if($_POST["submit"]=="submit-close")
	{
		echo "<script>location.href = 'manage-workshop.php'</script>";
	}
	else
	{
		echo "<script>location.href = 'edit-workshop.php?id=$id'</script>";
	}
}
?>
<!DOCTYPE html>
                                ...
                                <div class="tab-content">                                
									...
									<div class="row-fluid">
										...
										<div class="widget well">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" value="" class="validate[required] input-xlarge" name="workshop" id="workshop"/>
												</div>
											</div>
	                                ...
	                                <div class="tab-pane <?php if(isset($_SESSION["tab"]) && $_SESSION["tab"]=="Bill") echo "active";?>" id="tab3">
                                    	<div class="well row-fluid">
                                            ...
                                            You Need to save Workshop for adding Tabs.
