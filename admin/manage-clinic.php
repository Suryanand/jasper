	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
		    	...
		    	<h5 class="widget-name"><i class="icon-th"></i>Manage Clinic
                <a href="new-clinic.php" style="float:right;color:#555 !important;"><i style="padding:4px;" class="icon-plus"></i>Add New</a>
                <a href="export-hospital.php?id=1" style="float:right;color:#555 !important;margin-right:10px;"><i style="padding:4px;" class="icon-download"></i>Export</a>
                </h5>
                ...
                <form id="validate" class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        <table class="table table-striped table-bordered table-checks media-table">
                            ...
                            <?php
								$rslt=mysqli_query($con,"SELECT t1.*,t2.fullName from tbl_firm t1 left join tbl_user_login t2 on t1.userId=t2.id where t1.companyType=1 ORDER BY sortOrder asc");
								$i=0;
								while($row=mysqli_fetch_array($rslt))
								{
