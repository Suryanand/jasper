...
if(isset($_POST["delete"]))
{
	...
	echo "<script>location.href = 'appointments.php';</script>";exit();
}
?>
<!DOCTYPE html>
<html lang="en">
	...
	<div id="container">
		...
		<div id="content">
		    ...
		    <div class="wrapper">
		    	...
		    	<h5 class="widget-name"><i class="icon-th"></i>Doctor Appointments
                </h5>
                ...
                <form id="validate" class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                        <table class="table table-striped table-bordered table-checks media-table">
                            ...
                            <?php
								$rslt=mysqli_query($con,"select t1.*,t2.fullName as doctor from tbl_appointments t1,tbl_trainers t2 where t1.doctorId=t2.id order by t1.appointmentDate asc");
								$i=0;
