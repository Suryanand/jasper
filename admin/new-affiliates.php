...
if(isset($_POST["submit"]))
{
	...
	$rslt=mysqli_query($con,"select * from tbl_affiliates where affiliates='$affiliates'");
	...
	mysqli_query($con,"insert into tbl_affiliates (affiliates,description,image,titleTag,metaDescription,metaKeywords,urlName)values('".$affiliates."','".$description."','".$imageName."','$titleTag','$metaDescription','$metaKeywords','$urlName')") or die(mysqli_error($con));
	$rslt=mysqli_query($con,"select id from tbl_affiliates order by id desc limit 1");
	$row=mysqli_fetch_assoc($rslt);
	$id=$row['id'];
					

	if($_POST["submit"]=="submit-close")
		echo "<script>location.href = 'manage-affiliates.php'</script>";
	else
		echo "<script>location.href = 'edit-affiliates.php?id=".$id."'</script>";
	}
}
?>
<!DOCTYPE html>
		    ...
		    <div class="wrapper">
				...
				<form id="validate" class="form-horizontal" action="" enctype="multipart/form-data" method="post">
	                <fieldset>
	                    ...
	                    <!-- Form validation -->
	                    <div class="widget">
	                        <div class="navbar"><div class="navbar-inner"><h6>New Affiliates</h6></div></div>
							...
							<div class="well row-fluid">                            	                                
                                <div class="control-group">
	                                <label class="control-label">Affiliate: <span class="text-error">*</span></label>
	                                <div class="controls">
	                                    <input type="text" value="" class="validate[required] input-xlarge" name="affiliates" id="affiliates"/>					
