...
<html lang="en">
	<head>		
        ...
        <!-- flaticon css -->
		<link rel="stylesheet" href="<?php echo $absolutePath;?>assets/flaticon/flaticon.css">
		<style>
...
<!--                                                   						<div class="container">
 					...
 					<ol class="breadcrumb" style="text-transform: capitalize!important;">
                                            <li><a href="<?php echo $absolutePath;?>">home</a> / <a href="javascript:history.go(-1)"><?php echo $row6['categoryName']?> /</a><?php echo strtolower($companyName);?></li>                                            
			...
			<div class="container "> <!-- Start container --> 			
				<div class="row">
					...
					<div class="col-md-8">	
                       ...
                       <?php if(!empty($firmImage)){?><img src="<?php echo $absolutePath."uploads/images/firms/".$firmImage;?>" style="width:100%"><?php }?>
                       </div>
<div class="col-md-6">
<h3 class="m-0"><?php echo $companyName;?></h3>
<p class="mt-10 udl"><?php echo $area;?> <?php echo $location;?></p>  
<?php if($address!=''){ ?><i class="fa fa-map-marker" aria-hidden="true" style="margin-right:10px; float: left; margin-top: 14px;"></i>                     
<p class="mt-10 udl"><?php echo $address;?></p><?php } ?>
<?php if($email!='') { ?><p class="mt-10 udl"><i class="fa fa-envelope mr-10" aria-hidden="true"></i><?php echo $email;?></p><?php } ?>
<p class="mt-10 udl"><?php if($contactNo!=''){ ?><i class="fa fa-mobile mr-10" aria-hidden="true" style="font-size: 30px;"></i><?php echo $contactNo;?>,<?php } ?> <?php if($fax!=''){ ?><i class="fa fa-fax mr-10" aria-hidden="true"></i> <?php echo $fax;?><?php } ?></p>
<?php if($work_hours!=''){ ?><p class="mt-10"><i class="fa fa-clock-o mr-10" aria-hidden="true" style="font-size: 30px;"></i> <?php echo $work_hours;?></p><?php } ?>
<p class="mt-10">
...
<h5 style="color:black;float: left;padding: 0px  3px 21px;" title="<?php echo $row['name'];?>"><?php echo $row['icon'];?></h5>
<?php }}}?></p>
</div>
<?php if($contactNo!=''){ ?>
...
<a href="callto:<?php echo $contactNo;?>" class="health-care-btn view-all-btn wht" style="    padding: 10px 13px !important;     color: #fff !important;">Call Now</a>
</div><?php } ?>
</div>
...
?>
<button class="tablinks" onclick="openCity(event, '3')">Doctors</button>
<?php } ?>
<?php
if($companyType==1||$companyType==2||$companyType==3){
?>
<button class="tablinks" onclick="openCity(event, '4')">Insurance</button>
<?php } ?>
<button class="tablinks" onclick="openCity(event, '5')">Contact Us</button>
<?php
if($companyType==1||$companyType==2||$companyType==3){
?>
<button class="tablinks" onclick="openCity(event, '6')">Gallery</button>
<?php } ?>
</div><br clear="all">
...
<?php
$sl=1;
$rslt=mysqli_query($con,"select * from tbl_trainers where type=3 and activeStatus=1 and practice like '%$uid%' order by fullName asc");
while($row=mysqli_fetch_array($rslt)){ $sl++;	?>  
<div class="col-md-3 col-sm-3 col-xs-3 p-0" style="padding: 15px; text-align:center;     border: 1px solid #eeee;">
<span>
<a href="<?php echo $absolutePath;?>doctors/<?php echo $row['urlName'];?>">
<img src="<?php echo $absolutePath;?>uploads/images/trainers/<?php echo $row['image'];?>" style="width:100px;height:100px"><br><?php echo substr($row['fullName'],0,15);?>...</a>
</span>
</div>
<?php if($sl%4==1){ echo"<tr>";}}?>    
<?php
//if(!empty($doctor)){
//$sl=1;
...
?>
<?php// if(in_array($row["id"],$catArray)){?>    
<!--<td><a href="<?php echo $absolutePath;?>doctors/<?php echo $row['urlName'];?>"><img src="<?php echo $absolutePath;?>uploads/images/trainers/<?php echo $row['image'];?>" style="width:100px;height:100px"><br><?php echo substr($row['fullName'],0,10);?>...</a></td>-->
...
<div class="ins-img">
<a href="<?php echo $absolutePath;?>insurance-detail/<?php echo $row['id']?>"><img src="<?php echo $absolutePath;?>uploads/images/insurance/<?php echo $row['logo'];?>" style="width:200px;height:100px"></a>
</div>
</div>
<?php }}?>
</div> 
...
<div>
<?php
$rslt=mysqli_query($con,"select * from tbl_firm_gallery where firm_id=$uid");
while($row=mysqli_fetch_array($rslt))
{
?>    
<a class="example-image-link" href="<?php echo $absolutePath;?>uploads/images/gallery/<?php echo $row['image'];?>" data-lightbox="example-set" data-title=""><img class="example-image" src="<?php echo $absolutePath;?>uploads/images/gallery/<?php echo $row['image'];?>" height="100px" width="100px" alt=""/></a>
<?php } ?>
</div>
</section>
</div>     
...
<?php
//$rslt6=mysqli_query($con,"select * from tbl_firm_timing where hosid='$uid'");
//$row6=mysqli_fetch_assoc($rslt6);
...
<form method="post" action="<?php echo $absolutePath;?>firm-specialty">
<input type="hidden" name="comp" value="<?php echo $companyType;?>">  
<?php
...
?>
<?php if(in_array($row["id"],$catArray)){?> 
<!--<input type="text" name="spec" value="<?php echo $row['id'];?>">  -->
<button name="spec" class="tm" value="<?php echo $row['id'];?>"><?php echo $row['Name'];?></button>
<!--<input type="submit" name="firmsubmit" value="<?php echo $row['Name'];?>" class="tag-bt">-->
<?php }}?>
</form>
</div>
</div>
...
<?php } ?>
<?php
$rslt=mysqli_query($con,"select * from tbl_firm where companyType='$companyType' and id!=$uid and activeStatus=1 order by companyName asc limit 4");
while($row=mysqli_fetch_assoc($rslt)){
...
<div class="col-md-12 mb-10" style="    height: 120px; overflow: hidden;">
<img src="<?php echo $image;?>" width="80%" height="auto">
</div>
<div class="col-md-9">
...
.flaticon-money-24-hours-service-by-telephone:before {
