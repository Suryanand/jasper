					...
					<div class="col-sm-6 col-md-6" style="padding:5px !important">
                        ...
                        <a href="<?php if($row["postType"]==3) echo $absolutePath."uploads/pdf/".$row["link"]; elseif($row["postType"]==2) echo $row["link"]; else echo $absolutePath."article/".$row["urlName"];?>">
							...
							<div class="post-content">
								<h3><b><?php echo substr($row["title"],0,20);?>...</b></a></h3>						
...
<div class="tab">
<button class="tablinks" onclick="openCity(event, '1')" id="defaultOpen" style="width: 50%;">Most Popular</button>
<button class="tablinks" onclick="openCity(event, '2')" style="width: 50%;">Most Discussed</button>
</div>
...
<h4><b><?php echo substr($row5['title'],0,28);?></b></h4>
