...
?>
<?php
$rslt=mysqli_query($con,"select * from tbl_category where id='$fid'");
$row=mysqli_fetch_assoc($rslt);
        ...
        <div class="health-care-content-block solid-color"> <!-- Start Content Block -->			
			<div class="container "> <!-- Start container --> 			
				<div class="row">
					...
					if(!empty($loc))
						$qry=" and location like '%".$loc."%' or area like '%".$loc."%'";
					else
						$qry="";
                                        
					$rslt=mysqli_query($con,"select * from tbl_gymnasium where activeStatus=1 and (companyName like '%".$key."%' OR profile like '%".$key."%' and specialty like '%".$spec."%'".$qry.") and companyType=$fid");
