...
if($specid=='')
{
header('location:fitness-trainers.php');
}
?>
<!DOCTYPE html>
...
<?php
$rslt6=mysqli_query($con,"select * from tbl_fitness_specialty where id=$specid");
$row6=mysqli_fetch_assoc($rslt6);
?>                          
                <h2 class="wow fadeInDown"><?php echo $row6['Name']?></h2>
                <ol class="breadcrumb">
                          <li><a href="index.php">Home</a></li>
                          <li class="active"><?php echo $row6['Name']?></li>
                        </ol>
              </div>
                    </div>
          </div>
...
<!--              <div class="col-md-4">
        ...
        <div class="contact-info wow fadeIn">
                  ...
                  <?php 
						$rslt=mysqli_query($con,"select * from tbl_fitness_specialty order by id DESC");
        ...
        <div class="contact-info wow fadeIn">
                  ...
                  <?php 
						$rslt=mysqli_query($con,"select distinct location from tbl_trainers where activeStatus=1 and type=0");
						while($row=mysqli_fetch_assoc($rslt))
						{
						?>
                  <label class="filter-label">
        ...
        <?php /*<h4 class="sidebar-title">Rating</h4>
              ...
              <div class="col-md-12 doctors_list p-0" style="border: 1px solid #d8d8d8;">
        <?php 
					$rslt=mysqli_query($con,"select * from tbl_trainers where activeStatus=1 and type=0 and specialized like '%$specid%'");
					while($row=mysqli_fetch_assoc($rslt))
					{
						if(!empty($row["image"]))
						{
...
//						$row5=mysqli_fetch_assoc($rslt5);
       ...
       <a href="<?php echo $absolutePath;?>trainers/<?php echo $row["urlName"];?>"> <div class="col-md-4 p-0 black-tab">
