...
header('location:'.$absolutePath.'gymnasiums');
}
        ...
        <div class="health-care-content-block solid-color"> <!-- Start Content Block -->			
			<div class="container "> <!-- Start container --> 			
				<div class="row">
					...
					<div class="col-md-12">
					<?php 
					$rslt=mysqli_query($con,"select * from tbl_gymnasium where activeStatus=1 and specialty like '%".$spec."%' and companyType='$comp'");
					...
					<div class="col-md-10">
                        <a href="<?php echo $absolutePath.'gymnasiums/'.$row["urlName"];?>"><h3><?php echo $row["companyName"];?></h3></a>
