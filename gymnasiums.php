...
<html lang="en">
	...
	<body>	
		...
		<div class="home-slider-wrapper" id="top"> 
			<div class="home-slider"> <!-- Start Slider -->
				<div class="Breadcrumbs page-header-img-1"> <!-- Slider Image -->	
							...
							<div class="container">
								<div class="row">
									<div class="col-md-12 slider-content"> <!-- Slider Text & Button -->
										<h2 class="wow fadeInDown">Gymnasiums</h2>
                                                                                						<div class="container">
					...
					{?>
                                ...
                                <div class="col-md-3 col-xs-12 p-0 mr-5 mb-20">
                                <div class="subscribe-form wow fadeInUp">  <!-- Subscribe Form -->
                                     <select name="spec" class="form-control ico-01">
					...
					{?>
                                ...
                                <div class="subscribe-form wow fadeInUp">  <!-- Subscribe Form -->
                                            ...
                                            <input type="text" id="subscriber-email2" name="key" placeholder="Search <?php echo $categoryName;?>..." class="form-control ico-02">												
                                        </div>
                                </div>
 		...
 		<ol class="breadcrumb">
                                <li><a href="<?php echo $absolutePath;?>">Home</a> / <?php echo $urlName;?></li>                                          
			...
			<div class="container "> <!-- Start container --> 
				...
				<div class="row">
                    ...
                    <div class="contact-info wow fadeIn">
						...
						<?php 
						$rslt=mysqli_query($con,"select distinct area from tbl_gymnasium where companyType='$companyType' order by area asc limit 0,5");
						while($row=mysqli_fetch_assoc($rslt))
						{
						?>
						...
						<?php }?>
                                                	<?php 
						$rslt=mysqli_query($con,"select distinct area from tbl_gymnasium where companyType='$companyType' order by area asc limit 5,1000");
						while($row=mysqli_fetch_assoc($rslt))
						{
						?>
                      ...
                      <div class="contact-info wow fadeIn">
						...
						<?php 
						$rslt=mysqli_query($con,"select distinct specialty from tbl_gymnasium where specialty!=''");
						while($row=mysqli_fetch_assoc($rslt))
						{
...
$rslt=mysqli_query($con,"select * from tbl_fitness_specialty order by Name asc limit 2,1000");
while($row=mysqli_fetch_array($rslt))
{											
?>
<?php if(in_array($row["id"],$catArray)){?>     
<label class="filter-label moretext2"><input type="checkbox" class="location" value="<?php echo $row["id"];?>"><?php echo $row['Name'];?></label>
<?php }}?>
<?php
$catArray=explode(',',$specialty);
$rslt=mysqli_query($con,"select * from tbl_fitness_specialty order by Name asc limit 2");
while($row=mysqli_fetch_array($rslt))
{											
?>
<?php if(in_array($row["id"],$catArray)){?>     
...
<!--                      <div class="contact-info wow fadeIn">
						...
						<?php 
						$rslt=mysqli_query($con,"select distinct insurance from tbl_gymnasium where insurance!=''");
						while($row=mysqli_fetch_assoc($rslt))
						{
...
<?php }}}?>
					...
					<div class="col-md-9 hospital_list">
					<?php 
					$rslt=mysqli_query($con,"select * from tbl_gymnasium where companyType='1' order by companyName asc");
					while($row=mysqli_fetch_assoc($rslt))
					{
