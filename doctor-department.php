...
<?php
$rslt6=mysqli_query($con,"select * from tbl_specialty where id=$specid");
...
<!--              <div class="col-md-4">
        ...
        <div class="contact-info wow fadeIn">
                  ...
                  <?php 
						$rslt=mysqli_query($con,"select distinct location from tbl_trainers where activeStatus=1 and type=3");
						while($row=mysqli_fetch_assoc($rslt))
						{
						?>
                  <label class="filter-label">
        ...
        <?php 
					$rslt=mysqli_query($con,"select * from tbl_trainers where activeStatus=1 and type=3 and specialized like '%$specid%'");
					while($row=mysqli_fetch_assoc($rslt))
					{
						if(!empty($row["image"]))
						{
